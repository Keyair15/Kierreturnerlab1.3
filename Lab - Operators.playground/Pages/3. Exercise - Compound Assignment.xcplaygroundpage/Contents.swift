...
var myScore = 10
myScore += 5
print ("myscore has been updated to 15")
myScore *= 2
print ("myScore has been updated to 30")
...
var piggyBank = 0
piggyBank += 10
print("MY piggyBank has the value of $10")
piggyBank += 20
print ("MY piggyBank has the value of $30")
piggyBank -= 15
print("My piggy bank value is $15")
piggyBank *= 3
print ("My piggyBank value is $55")
piggyBank -= 3
print("My piggyBankhas the value of $52")
